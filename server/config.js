module.exports = {
    ...
    ENEMY_CAP_CNEST: 4, // Max nest enemies per crasher nest tile.
    ENEMY_SPAWN_CHANCE_CNEST: 0.6, // Likeliness of nest enemies spawn attempts succeeding.
    ENEMY_SPAWN_COOLDOWN_CNEST: 45, // Cooldown (in game ticks) of nest enemies spawn attempts being made.

    ENEMY_CAP_NEST: 1, // Max nest enemies per nest tile.
    ENEMY_SPAWN_CHANCE_NEST: 0.8, // Likeliness of nest enemies spawn attempts succeeding.
    ...
    BOSS_SPAWN_DURATION: 0,

    // The possible food types that can spawn.
    FOOD_TYPES: [
        [2000, [
            [160, 'square'], [130, 'egg'], [90, 'triangle'], [20, 'pentagon'], [4, 'betaPentagon'], [1, 'alphaPentagon']
        ]],
        [1, [
            [3125, 'gem'], [3125, 'shinyEgg'], [625, 'shinySquare'], [125, 'shinyTriangle'], [25, 'shinyPentagon'], [5, 'shinyBetaPentagon'], [1, 'shinyAlphaPentagon']
        ]],
        [0.1, [
            [6836, 'jewel'], [6836, 'legendaryEgg'], [1296, 'legendarySquare'], [216, 'legendaryTriangle'], [36, 'legendaryPentagon'], [6, 'legendaryBetaPentagon'], [1, 'legendaryAlphaPentagon']
        ]],
        [0.005, [
        ...
        [0.0001, [
            [100000, 'albinoEgg'], [10000, 'albinoSquare'], [1000, 'albinoTriangle'], [100, 'albinoPentagon'], [10, 'albinoBetaPentagon'], [1, 'albinoAlphaPentagon']
        ]],
        [0.00005, [
            [100000, 'epilepsyEgg'], [10000, 'epilepsySquare'], [1000, 'epilepsyTriangle'], [100, 'epilepsyPentagon'], [10, 'epilepsyBetaPentagon'], [1, 'epilepsyAlphaPentagon']
        ]],
        [0.00001, [
            [100000, 'blackEgg'], [10000, 'blackSquare'], [1000, 'blackTriangle'], [100, 'blackPentagon'], [10, 'blackBetaPentagon'], [1, 'blackAlphaPentagon']
        ]]
    ],
    ...
    FOOD_TYPES_NEST: [
        [1, [
            [16, 'pentagon'], [4, 'hexagon'], [ 4, 'betaPentagon'], [ 1, 'alphaPentagon']
        ]]
    ],
    ...
    ENEMY_TYPES_CNEST: [
        ...
        [50, [
            [5, 'sentryGun'], [5, 'sentrySwarm'], [5, 'sentryTrap'], [4, 'sentrySniper']
        ]],
		[5, [
			[1, 'sentinelMinigun'], [1, 'sentinelCrossbow'], [1, 'sentinelLauncher'], [0.2, 'hexentinelMinigun'], [0.2, 'hexentinelCrossbow'], [0.2, 'hexentinelLauncher']
		]],
		[0.01, [
			[50, 'shinySentry'], [1, 'shinySentryGun'], [1, 'shinySentrySwarm'], [1, 'shinySentryTrap'], [1, 'shinySentrySniper']
		]]
    ],
    ...
    BOSS_TYPES: [{
        bosses: ["guardian", "eliteDestroyer", "eliteGunner", "eliteSprayer", "eliteBattleship", "eliteSpawner", "eliteTrapGuard", "eliteSpinner"],
        amount: [10, 7, 4, 2, 1], chance: 2, nameType: "a",
    },{
        bosses: ["roguePalisade", "rogueArmada"],
        amount: [5, 2, 1], chance: 1, nameType: "castle",
        message: "A strange trembling...",
    },{
        bosses: ["AKEE87", "summoner", "eliteSkimmer", "nestKeeper"],
        amount: [5, 2, 1], chance: 1, nameType: "a",
        message: "A strange trembling...",
    },{
        bosses: ["fallenAutoSmasher", "fallenBooster", "fallenOverlord", "fallenFortress", "fallenFocal", "fallenBarricade", "fallenNecromancer", "fallenAssembler"],
        amount: [8, 6, 3, 1], chance: 0.8, nameType: "castle",
        message: "The fallen warriors are reborn anew!",
    },{
        bosses: ["ares", "gersemi", "ezekiel", "eris", "selene"],
        amount: [30, 4, 2, 1], chance: 0.1,
        message: "The terrestrial are reborn anew!",
    },{
        bosses: ["paladin", "freyja", "zaphkiel", "nyx", "theia", "atlas", "odin"],
        amount: [40, 4, 1], chance: 0.03,
        message: "The world tremors as the celestials are reborn anew!",
    },{
        bosses: ["julius", "genghis", "napoleon", "rhea"],
        amount: [40, 4, 1], chance: 0.03,
        message: "The darkness arrives as the realms are torn apart!",
    },{
        bosses: ["legionaryCrasher"],
        amount: [1], chance: 0.0003,
        message: "The Elite Crashers were all but disciples for what you have awoken... What have you done?",
    },{
        bosses: ["kronos"],
        amount: [1], chance: 0.0002,
        message: "The sky darkens as the ground slowly begins to crumble... The end is near.",
    },{
        bosses: ["ragnarok"],
        amount: [1], chance: 0.0001,
        message: "Do you believe in Ragnarok?",
    },{
        bosses: ["zeus"],
        amount: [1], chance: 0.00001,
        message: "The lighting strikes arena, as a giant Boss is slowly entering the battlefield!",
    }],
