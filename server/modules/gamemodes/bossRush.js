...
let oldGroups = {
    ...
    eternals: [ "legionaryCrasher", "kronos", "ragnarok" ],
};
...
class BossRush {
    constructor() {
        ...
        this.friendlyBossChoices = [ [9, "roguePalisade"], [8, "rogueArmada"], [1, "julius"], [1, "genghis"], [1, "napoleon"], [1, "rhea"] ];
        this.bigFodderChoices = ["sentryGun", "sentrySwarm", "sentryTrap", "sentrySniper", "shinySentryGun"];
