...
Class.auraSmasher = {
	...
	SKILL_CAP: [smshskl, 0, 0, smshskl, 0, smshskl, smshskl, smshskl, smshskl, smshskl]
}
...
Class.hesmos = {
    ...
    GUNS: [
        ...
        },
        {
            ...
            PROPERTIES: {
                SHOOT_SETTINGS: combineStats([g.basic, g.healer, g.desmos]),
...
Class.doubleFlail2 = {
    PARENT: "genericFlail",
    LABEL: "Double Flail V2",
    DANGER: 7,
    TURRETS: [{
        POSITION: [6, 10, 0, 15, 190, 0],
        TYPE: ["flailBolt3", {
            INDEPENDENT: true
        }]
    }, {
        POSITION: [6, 10, 0, 345, 190, 0],
        TYPE: ["flailBolt3", {
            INDEPENDENT: true
        }]
    }]
...
Class.cataclysmDeco = makeDeco(10)
Class.cataclysmDeco.CONTROLLERS = [["spin", { independent: true, speed: 0.128 }]]
...
Class.cataclysm.UPGRADE_COLOR = "rainbow"
...
// Upgrade Paths
Class.basic.UPGRADES_TIER_1 = ["twin", "sniper", "machineGun", "flankGuard", "director", "pounder", "trapper", "desmos", "whirlwind", "flail"]
    Class.basic.UPGRADES_TIER_2 = ["smasher", "healer"]
		Class.basic.UPGRADES_TIER_5 = ["literallyATank"]
        Class.smasher.UPGRADES_TIER_3 = ["megaSmasher", "spike", "autoSmasher", "landmine", "auraSmasher", "cocci"]
			Class.smasher.UPGRADES_TIER_5 = ["jumpSmasher"]
        Class.healer.UPGRADES_TIER_3 = ["medic", "ambulance", "surgeon", "paramedic", "hesmos", "auraHealer"]
    ...
    Class.machineGun.UPGRADES_TIER_2 = ["artillery", "minigun", "gunner", "sprayer"]
		...
		Class.machineGun.UPGRADES_TIER_5 = ["literallyAMachineGun"]
    ...
    Class.flankGuard.UPGRADES_TIER_2 = ["hexaTank", "triAngle", "auto3", "trapGuard", "triTrapper"]
        ...
        Class.triAngle.UPGRADES_TIER_3 = ["fighter", "booster", "falcon", "bomber", "autoTriAngle", "auraTriAngle", "surfer", "eagle", "phoenix", "vulture"]
			Class.triAngle.UPGRADES_TIER_5 = ["master"]
    ...
    Class.director.UPGRADES_TIER_2 = ["overseer", "cruiser", "underseer", "spawner"]
        ...
        Class.cruiser.UPGRADES_TIER_3 = ["carrier", "battleship", "fortress", "autoCruiser", "commander"]
			Class.cruiser.UPGRADES_TIER_5 = ["cruisership"]
    ...
    Class.pounder.UPGRADES_TIER_2 = ["destroyer", "builder", "artillery", "launcher"]
        ...
        Class.launcher.UPGRADES_TIER_3 = ["skimmer", "twister", "swarmer", "rocketeer", "fieldGun", "sidewinderOld"]

    Class.trapper.UPGRADES_TIER_2 = ["builder", "triTrapper", "trapGuard"]
        Class.trapper.UPGRADES_TIER_3 = ["barricade", "overtrapper"]
	        Class.trapper.UPGRADES_TIER_5 = ["trooster"]
    ...
    Class.desmos.UPGRADES_TIER_2 = ["helix", "sidewinder"/*, "undertow", "repeater"*/] //tanks make the server lag!
		Class.desmos.UPGRADES_TIER_5 = ["volute"]
        Class.helix.UPGRADES_TIER_3 = ["triplex", "quadruplex", "coil", /*"duplicator"*/]
        Class.sidewinder.UPGRADES_TIER_3 = ["coil", "ranch"/*, "python", "oroboros"*/] //placeholders
        Class.undertow.UPGRADES_TIER_3 = ["riptide"]
        Class.repeater.UPGRADES_TIER_3 = ["iterator", "duplicator"]

	Class.flail.UPGRADES_TIER_2 = ["doubleFlail", "mace", "flangle", "spear"]
		Class.flail.UPGRADES_TIER_3 = ["auraFlail"]
			Class.flail.UPGRADES_TIER_5 = ["hexaFlail"]
        Class.doubleFlail.UPGRADES_TIER_3 = ["doubleFlail2", "tripleFlail", "doubleMace", "doubleSpear"]
        Class.mace.UPGRADES_TIER_3 = ["bigMama", "itHurtsDontTouchIt", "flace", "doubleMace", "gladius"]
        Class.flangle.UPGRADES_TIER_3 = ["autoFlangle", "flooster", "flace", "harpoon"]
		Class.spear.UPGRADES_TIER_3 = ["doubleSpear", "gladius", "harpoon", "pike"]
	...
	Class.whirlwind.UPGRADES_TIER_2 = ["tornado", "hurricane"]
        Class.whirlwind.UPGRADES_TIER_3 = ["hexaWhirl", "munition", "whirl3", "whirlGuard", /*"prophet",*/ "vortex"]
			Class.whirlwind.UPGRADES_TIER_5 = ["cataclysm"]
