...
Class.gunWall = makeAuto({
    ...
    SHAPE: 4,
    VARIES_IN_SIZE: false,
}, "gunWall", {type: "autoGunWallTurret", size: 8})
Class.moon = {
    PARENT: "rock",
    LABEL: "Moon",
    SIZE: 60,
...
Class.overDominator = {
    PARENT: "dominator",
    UPGRADE_LABEL: 'Overlord',
    FACING_TYPE: ["spin", {speed: 0.02}],
	MAX_CHILDREN: 12,
    GUNS: weaponArray({
        POSITION: [4, 8, 1.2, 8, 0, 0, 0],
        PROPERTIES: {
            SHOOT_SETTINGS: combineStats([g.drone, g.overseer, {health: 2, damage: 2}]),
            TYPE: "drone",
            AUTOFIRE: true,
            SYNCS_SKILLS: true,
...
Class.fortressDominator = {
    PARENT: "dominator",
    UPGRADE_LABEL: 'Fortress',
    FACING_TYPE: ["spin", {speed: 0.02}],
    GUNS: [
		...weaponArray([
        {
            POSITION: [4, 3.75, 1.3, 8, 0, 0, 0]
        },
        {
            POSITION: [1.75, 3.75, 1.7, 12, 0, 0, 0],
            PROPERTIES: {
                SHOOT_SETTINGS: combineStats([g.trap, g.trapperDominator]),
                TYPE: "trap",
                STAT_CALCULATOR: "trap",
...
Class.swarmerDominator = {
    PARENT: "dominator",
    UPGRADE_LABEL: 'Swarmer',
    GUNS: [
        {
            POSITION: [11, 6.75, -1, 5, 0, 0, 0],
            PROPERTIES: {
                SHOOT_SETTINGS: combineStats([g.basic, g.swarmerDominator]),
                TYPE: "hive",
            },
        },
        {
            POSITION: [11, 5, 1, 5, 0, 0, 0],
        },
        {
            POSITION: [5, 6.75, -1.6, 6.75, 0, 0, 0]
        }
...
Class.sentrySniper = makeAuto("sentry", "Sentry", {
    type: "AutoSniperGun",
    size: 12,
});
Class.sentrySniper.UPGRADE_LABEL = "Sniper Sentry";
...
Class.shinySentrySniper = makeAuto("shinySentry", "Sentry", {
    type: "rifleTurret",
    size: 12,
});
Class.shinySentryGun.UPGRADE_LABEL = "Shiny Sniper Sentry";
...
Class.hexentinel = {
    ...
    SKILL: skillSet({
        rld: 0.75, //reload
        dam: 0.55, //bullet damage
        pen: 0.65, //bullet penetration
        str: 0.65, //bullet health
        atk: 0.6, //bullet speed
        spd: 0.8, //body damage
        hlt: 0.95, //max health
        shi: 0.5, //shield capacity
...
Class.hexentinelLauncher = {
    PARENT: "hexentinel",
    UPGRADE_LABEL: "Missile Hexentinel",
    ...
    GUNS: [
        {
            ...
            PROPERTIES: {
                SHOOT_SETTINGS: combineStats([g.basic, g.pounder, g.launcher]),
                TYPE: "hexentinelMissile",
            },
        }, {
            POSITION: [17.5, 15, 1.25, 0, 0, 0, 0],
        }, {
            POSITION: [18.55, 20.25, 0.25, 1, 0, 0, 0],
        },
    ],
};
Class.hexentinelCrossbow = {
    PARENT: "hexentinel",
    UPGRADE_LABEL: "Crossbow Hexentinel",
    UPGRADE_COLOR: "hexagon",
    GUNS: [
        {
            POSITION: [17, 2.5, 1, 0, 3.5, 30/2, 2/3],
            PROPERTIES: {
                SHOOT_SETTINGS: combineStats([g.basic, g.sniper, g.rifle, { speed: 0.7, maxSpeed: 0.7 }, g.crossbow, { recoil: 0.5 }]),
                TYPE: "bullet",
            },
...
Class.hexentinelMinigun = {
    PARENT: "hexentinel",
    UPGRADE_LABEL: "Minigun Hexentinel",
    UPGRADE_COLOR: "hexagon",
    GUNS: [
        {
            POSITION: [16, 7.5, 1, 0, 4.5, 0, 0],
            ...
            POSITION: [13, 7.5, 1, 1, 4.5, 0, 1/3],
            PROPERTIES: {
                SHOOT_SETTINGS: combineStats([g.basic, g.minigun, g.twin, g.spam, g.spam]),
                TYPE: "bullet",
            },
        }, {
            POSITION: [10, 7.5, -1.33, 1, 4.5, 0, 2/3],
            PROPERTIES: {
                SHOOT_SETTINGS: combineStats([g.basic, g.minigun, g.twin, g.spam, g.spam]),
                TYPE: "bullet",
            },
            ...
            POSITION: [20.4, 9, 1, 0, 0, 0, 1/4],
            PROPERTIES: {
                SHOOT_SETTINGS: combineStats([g.basic, g.minigun, g.twin, g.spam, g.spam]),
                TYPE: "bullet",
            },
        }, {
            POSITION: [18.3, 9, 1, 0, 0, 0, 2/4],
            PROPERTIES: {
                SHOOT_SETTINGS: combineStats([g.basic, g.minigun, g.twin, g.spam, g.spam]),
                TYPE: "bullet",
            },
        }, {
            POSITION: [16.2, 9, 1, 0, 0, 0, 3/4],
            PROPERTIES: {
                SHOOT_SETTINGS: combineStats([g.basic, g.minigun, g.twin, g.spam, g.spam]),
                TYPE: "bullet",
            },
...
Class.tracker3.UPGRADES_TIER_0 = ["tracker6", "tracker9", "tracker15", "tracker66"]