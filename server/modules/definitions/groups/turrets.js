...
Class.AutoSniperGun = makeTurret({
    GUNS: [
        {
...
Class.autoSpikeLauncherTurret = makeTurret({
    GUNS: [
        {
            POSITION: [4, 12, 1.2, 16, 0, 0, 0],
        }, {
            POSITION: [18, 20, -0.7, 0, 0, 0, 0],
            PROPERTIES: {
                SHOOT_SETTINGS: combineStats([g.basic, g.pounder, g.artillery, g.artillery, g.skimmer, { reload: 2.5, health: 2.3, damage: 2.4, resist: 1.2, speed: 1.3, maxSpeed: 1.3, range: 2.5 }]),
                TYPE: "autoSpikeMissile",
            },
        }, {
            POSITION: [18, 20, 0.25, 1, 0, 0, 0],
        },
    ],
}, {canRepel: true, limitFov: true, fov: 10, independent: true, extraStats: []})
Class.zeusSuperTurret = makeTurret({
    GUNS: [
        {
            POSITION: [8, 20, -0.25, 11, 0, 0, 0],
        },
		{
            POSITION: [15, 18, -0.8, 0, 0, 0, 0],
            PROPERTIES: {
                SHOOT_SETTINGS: combineStats([g.basic, g.pounder, g.artillery, g.artillery, g.skimmer, { reload: 2, health: 2, damage: 2, resist: 1.2 }]),
                TYPE: "zeusMissile",
            },
        }, {
            POSITION: [18, 20, 0.25, 1, 0, 0, 0],
...
Class.autoGunWallTurret = makeTurret({
    GUNS: [
        {
            POSITION: [18, 6, 1, 0, 4, 0, 0],
            PROPERTIES: {
                SHOOT_SETTINGS: combineStats([g.basic, { damage: 8, speed: 3, recoil: 0 }]),
                TYPE: "bullet",
                STAT_CALCULATOR: "fixedReload",
            },
        },
        {
            POSITION: [18, 6, 1, 0, -4, 0, 0.5],
            PROPERTIES: {
                SHOOT_SETTINGS: combineStats([g.basic, { damage: 8, speed: 3, recoil: 0 }]),
                TYPE: "bullet",
                STAT_CALCULATOR: "fixedReload",
...
Class.autoSpikeMissileTurret = makeTurret({
    HAS_NO_RECOIL: true,
    GUNS: [
        {
            POSITION: [19, 6, 1, 0, 4.5, 0, 0],
		...
		{
            POSITION: [4, 6, 1.6, 13, 4.5, 180, 0],
            PROPERTIES: {
                SHOOT_SETTINGS: combineStats([g.trap, g.twin, g.lowPower, {reload: 2, speed: 1.3, maxSpeed: 1.3, range: 0.5}]),
                TYPE: [ "trap", { PERSISTS_AFTER_DEATH: true } ],
                STAT_CALCULATOR: "trap",
            }
        },
        {
            POSITION: [4, 6, 1.6, 13, -4.5, 180, 0.5],
            PROPERTIES: {
                SHOOT_SETTINGS: combineStats([g.trap, g.twin, g.lowPower, {reload: 2, speed: 1.3, maxSpeed: 1.3, range: 0.5}]),
                TYPE: [ "trap", { PERSISTS_AFTER_DEATH: true } ],
                STAT_CALCULATOR: "trap",
		...
		{
            POSITION: [13, 6, 1, 0, 4.5, 180, 0],
        },
		{
            POSITION: [13, 6, 1, 0, -4.5, 180, 0.5],
        },
    ],
}, {fov: 5, independent: true, aiSettings: {SKYNET: true, BLIND: true}, extraStats: []})
