...
Class.AKEE87 = {
    ...
    TURRETS: [
		...
		...weaponArray({
            POSITION: [10, 7, 0, 0, 180, 0],
            TYPE: "nailgunTurret",
        }, 3),
		...weaponArray({
            POSITION: [10, 7, 0, 180, 180, 0],
            TYPE: "rifleTurret",
        }, 3)
	]
};
...
Class.fallenAutoSmasher = makeAuto({
    PARENT: "fallen",
	BODY: {
...
}, "Fallen Auto Smasher", {type: "autoSmasherTurret", size: 11});
Class.fallenBooster = {
    PARENT: "fallen",
...
Class.fallenOverlord = {
    ...
    GUNS: weaponArray({
        ...
        PROPERTIES: {
            SHOOT_SETTINGS: combineStats([g.drone, g.overseer, { reload: 1 }]),
            TYPE: "drone",
            AUTOFIRE: true,
            SYNCS_SKILLS: true,
            STAT_CALCULATOR: "drone",
...
Class.fallenBarricade = {
    PARENT: "fallen",
    LABEL: 'Fallen Barricade',
	FACING_TYPE: "toTarget",
    AI: { NO_LEAD: false },
...
Class.fallenAssembler = {
    PARENT: "fallen",
    LABEL: 'Fallen Assembler',
    STAT_NAMES: statnames.trap,
	FACING_TYPE: "toTarget",
    AI: { NO_LEAD: false },
	BODY: {
...
// ATLAS
let atlas = new LayeredBoss(null, "Atlas", "celestial", 9, "veryLightGrey", "baseTrapTurret", 6.5, 5.5);
...
// ODIN
let odin = new LayeredBoss(null, "Odin", "celestial", 9, "aqua", "baseTrapTurret", 6.5, 5.5);
odin.addLayer({gun: {
    POSITION: [3.8, 6, 1.4, 8, 0, null, 1],
    PROPERTIES: {
		MAX_CHILDREN: 2,
        SHOOT_SETTINGS: combineStats([g.drone, g.summoner, g.destroyer, {health: 1.6, damage: 1.6, resist: 1.2, density: 1.8, maxSpeed: 0.9}]),
...
// ZEUS
let zeus = new LayeredBoss(null, "Zeus", "superEternal", 17, "#2964fe", "baseTrapTurret", 3.5, 5.5);
zeus.addLayer({turret: {
    POSITION: [4.2, 9, 0, null, 160, 0],
    TYPE: "zeusSuperTurret",
}}, true, 3);
zeus.addLayer({turret: {
    POSITION: [4.2, 9, 0, null, 160, 0],
    TYPE: "autoSpikeLauncherTurret",
}}, true, 3);
zeus.addLayer({gun: {
    POSITION: [2.25, 4, -1.6, 9, 0, null, 0],
    PROPERTIES: {
		MAX_CHILDREN: 1,
        SHOOT_SETTINGS: combineStats([g.drone, g.summoner, g.pounder, g.destroyer, {speed: 1.4, maxSpeed: 1.4}]),
        TYPE: ["zeusMinion", {INDEPENDENT: true, COLOR: '#2964fe'}],
        AUTOFIRE: true,
        SYNCS_SKILLS: true,
    },
}}, true, 2.8);
...
zeus.addLayer({gun: {
    ...
    PROPERTIES: {
		MAX_CHILDREN: 3,
        SHOOT_SETTINGS: combineStats([g.drone, g.summoner, g.pounder, g.destroyer, {speed: 1.15, maxSpeed: 1.15}]),
        TYPE: ["superchip", {INDEPENDENT: true, DRAW_HEALTH: true, COLOR: '#2964fe'}],
        AUTOFIRE: true,
        SYNCS_SKILLS: true,
    },
}}, true, 2.6);
