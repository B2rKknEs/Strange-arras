...
Class.transEgg = makeRare("egg", 4);
Class.albinoEgg = makeRare("egg", 5);
Class.epilepsyEgg = makeRare("egg", 6);
Class.blackEgg = makeRare("egg", 7);
...
Class.albinoSquare = makeRare("square", 5);
Class.epilepsySquare = makeRare("square", 6);
Class.blackSquare = makeRare("square", 7);
...
Class.albinoTriangle = makeRare("triangle", 5);
Class.epilepsyTriangle = makeRare("triangle", 6);
Class.blackTriangle = makeRare("triangle", 7);
...
Class.albinoPentagon = makeRare("pentagon", 5);
Class.epilepsyPentagon = makeRare("pentagon", 6);
Class.blackPentagon = makeRare("pentagon", 7);
...
Class.albinoBetaPentagon = makeRare("betaPentagon", 5);
Class.epilepsyBetaPentagon = makeRare("betaPentagon", 6);
Class.blackBetaPentagon = makeRare("betaPentagon", 7);
...
Class.albinoAlphaPentagon = makeRare("alphaPentagon", 5);
Class.epilepsyAlphaPentagon = makeRare("alphaPentagon", 6);
Class.blackAlphaPentagon = makeRare("alphaPentagon", 7);
...
Class.albinoHexagon = makeRare("hexagon", 5);
Class.epilepsyHexagon = makeRare("hexagon", 6);
Class.blackHexagon = makeRare("hexagon", 7);
...
let polyNames = [ "egg", "square", "triangle", "pentagon", "hexagon" ],
    shinyNames = [ "", "shiny", "legendary", "shadow", "rainbow", "trans", "albino", "epilepsy", "black" ];
