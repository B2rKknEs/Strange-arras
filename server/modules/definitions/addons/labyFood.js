	...
	Config.FOOD_TYPES_NEST = Array(2).fill().map((_, i, a) => [
		...
		Array(6).fill().map((_, j, b) => [
			...
			Array(9).fill().map((_, k, c) => [
				...
				: // 2-wide dimension of the 2 shape "ranks" - normal, crasher
					[[25, `laby_${i+3}_${j}_${k}_0`], [1, `laby_${i+3}_${j}_${k}_1`]]
			])
		])
	]);
