...
var gameDraw = {
    ...
    reanimateColors: () => {
        let now = Date.now(),
            ...
            police_red = "#e94c3e",
            police_blue = "#319dcb",
            police_useSecondSet = five_bars < 2,
        ...
        gameDraw.animatedColor.police = gameDraw.mixColors(police_blue, 250 > now % 250 ? police_red : police_blue, Math.max(Math.min(5 * Math.sin(now % 250 / 250 * Math.PI) - 2, 1), 0)); // EPILEPSY WARNING
    ...
    getColor: (colorNumber) => {
        ...
        switch (colorNumber) {
            ...
            case "police":
                return gameDraw.animatedColor.police;
            case "rainbow":
            case "gay":
